defmodule Issues.TableFormatter do
  ...
  each columns. The `headers` parameter contains the
  ...
  hyphens, with + signs where the vartical bar between the columsns goes.
  ...
  @doc """
  Given a list containing rows of data, a list containing the header selectos,
